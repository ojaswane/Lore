...
pub fn output_shell(
    ...
    thread::spawn(move || { //The move keyword tells Rust to rip the variables out of the current function and give full ownership to a completely new background thread.
